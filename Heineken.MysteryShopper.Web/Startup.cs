...
using SurveyUs.Application.Extensions;
using SurveyUs.Infrastructure.Extensions;
using SurveyUs.Web.Abstractions;
using SurveyUs.Web.Extensions;
using SurveyUs.Web.Permission;
using SurveyUs.Web.Services;
using Wkhtmltopdf.NetCore;

namespace SurveyUs.Web
{
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{area=Campaign}/{controller=Campaign}/{action=Index}");
            });
        }
    }
}