...
namespace SurveyUs.Web.Areas.Admin.Controllers
{
    ...
    public class PermissionController : BaseController<PermissionController>
    {
        ...
        public async Task<ActionResult> Index(string roleId)
        {
            ...
            allPermissions.GetPermissions(typeof(Permissions.Stores), roleId);
            allPermissions.GetPermissions(typeof(Permissions.Bartenders), roleId);
